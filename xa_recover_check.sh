...
echo "Usage: [ options ]"
echo "Options:"
echo "  -m, --master Master info in the format '--host=<hostname> | --port=<port number> | --database=<database> | --user=<db user> | --password=<db password>'"
echo "  -s, --slave  Slave info in the format '--host=<hostname> | --port=<port number> | --database=<database> | --user=<db user> | --password=<db password>'"
}
