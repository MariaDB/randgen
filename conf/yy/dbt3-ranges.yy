...
where:
  where_list __and_x_or(80) where_list |
  ( where_list ) __and_x_or(80) ( where_list ) ;

where_list:
  ( where_item ) __and_x_or(80) ( where_list ) |
  ( where_item ) __and_x_or(80) ( where_item ) |
  where_item __and_x_or(80) where_list |
  where_item __and_x_or(80) where_item |
  where_item __and_x_or(80) where_item __and_x_or(80) where_item |
  where_item ;

where_item:
  key_clause |
  key_clause __and_x_or(20) key_clause ;
