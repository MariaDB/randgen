...
# From main.select
#
  ;; CREATE DATABASE IF NOT EXISTS mtr_main_select_db ;; { _set_db('mtr_main_select_db') } 
  ;; CREATE TABLE t1 (
       Period SMALLINT(4) UNSIGNED ZEROFILL DEFAULT '0000' NOT NULL,
       Varor_period SMALLINT(4) UNSIGNED DEFAULT '0' NOT NULL
     ) optional_local_engine
  ;; INSERT INTO t1 VALUES ({$prng->uint16(1,9999)},{$prng->uint16(1,9999)})
  ;; CREATE TABLE t2 (
  ...
  ;; INSERT INTO t3 (period,name,companynr,price,price2) VALUES (_smallint_unsigned,my_word,_tinyint_unsigned,_mediumint_unsigned,_mediumint_unsigned)
  ;; INSERT INTO t3 (period,name,companynr,price,price2) VALUES (_smallint_unsigned,my_word,_tinyint_unsigned,_mediumint_unsigned,_mediumint_unsigned)
  ;; INSERT INTO t3 (period,name,companynr,price,price2) VALUES (_smallint_unsigned,my_word,_tinyint_unsigned,_mediumint_unsigned,_mediumint_unsigned)
  ;; INSERT INTO t3 (period,name,companynr,price,price2) VALUES (_smallint_unsigned,my_word,_tinyint_unsigned,_mediumint_unsigned,_mediumint_unsigned)
  ;; INSERT INTO t3 (period,name,companynr,price,price2) VALUES (_smallint_unsigned,my_word,_tinyint_unsigned,_mediumint_unsigned,_mediumint_unsigned)
  ...
  ;; create table t4 (
    ...
    ) optional_local_engine t4_extra_params COMMENT='companynames'
  ;; INSERT INTO t4 (companynr, companyname) VALUES ({$prng->uint16(1,99)},my_word)
  ;; INSERT INTO t4 (companynr, companyname) VALUES ({$prng->uint16(1,99)},my_word)
  ;; INSERT INTO t4 (companynr, companyname) VALUES ({$prng->uint16(1,99)},my_word)
  ;; INSERT INTO t4 (companynr, companyname) VALUES ({$prng->uint16(1,99)},my_word)
  ;; INSERT INTO t4 (companynr, companyname) VALUES ({$prng->uint16(1,99)},my_word)
  ...
  ;; INSERT INTO t4 (companynr, companyname) VALUES ({$prng->uint16(1,99)},my_word)
  ;; INSERT INTO t4 (companynr, companyname) VALUES ({$prng->uint16(1,99)},my_word)
  ;; insert into t2 (fld1, companynr) values ({$prng->uint16(1,9999999)},{$prng->uint16(1,99)})
#
# From main.subselect_sj
#
  ;; CREATE DATABASE IF NOT EXISTS mtr_main_subselect_sj_db ;; { _set_db('mtr_main_subselect_sj_db') } 
  ;; CREATE TABLE t1 ( a VARCHAR(1) NOT NULL, KEY(a) )
  ;; INSERT INTO t1 VALUES (_char(1)),(_char(1)),('k'),('l')
...
t2_insert:
  INSERT IGNORE INTO t2 VALUES (NULL,{$prng->uint16(0,999999)},{$prng->uint16(0,99)},my_word,my_word,my_word,t2_fld6_val) ;

t2_insert_extra:
  INSERT IGNORE INTO t2 VALUES ({$prng->uint16(5900,6000)},{$prng->uint16(1232600,1232700)},{$prng->uint16(0,99)},'appendixes',my_word,my_word,t2_fld6_val) ;
...
query:
  # mtr_main_select_query has more different queries, hence the factor
  ==FACTOR:200== { _set_db('mtr_main_select_db') } mtr_main_select_query |
                 { _set_db('mtr_main_subselect_sj_db') } mtr_main_subselect_sj_query |
;

mtr_main_select_query:
...
mtr_main_subselect_sj_query:
  SELECT a, COUNT(*) FROM t1 WHERE a IN (SELECT b FROM t2 FORCE INDEX(b), t3 FORCE INDEX(c) WHERE c = b AND b = a) ;
