...
where_item:
	...
	existing_table_item . char_field_name arithmetic_operator _char  |
        ...
        table1 . opt_sq_port_field IS not NULL |
        table1 . int_field_name arithmetic_operator existing_table_item . int_field_name  |
	existing_table_item . char_field_name arithmetic_operator _char  |
        existing_table_item . char_field_name arithmetic_operator existing_table_item . char_field_name |
        table1 . opt_sq_port_field IS not NULL ;
...
################################################################################
new_table_item:
	opt_sq_port_table AS { "table".++$tables } | opt_sq_port_table AS { "table".++$tables } | opt_sq_port_table AS { "table".++$tables } |
...
subquery_new_table_item:
        opt_sq_port_table AS { "SUBQUERY".$subquery_idx."_t".++$subquery_tables } ;

child_subquery_new_table_item:
        opt_sq_port_table AS { "CHILD_SUBQUERY".$child_subquery_idx."_t".++$child_subquery_tables } ;      
