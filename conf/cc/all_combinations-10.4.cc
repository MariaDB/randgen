...
our ($optional_variators_104, $basic_engine_combinations_104, $extra_engine_combinations_104);
...
$combinations = [
  ...
  [
    {
      engines => [
        [ @$basic_engine_combinations_104, @$extra_engine_combinations_104 ],
