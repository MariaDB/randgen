...
$combinations = [
  ...
  [ {
      transform => [
        [ '--validators=TransformerNoComparator' ], @$optional_variators_105,
      ],
      notransform => [ '' ]
    }
  ],
  ...
  [
    {
      ...
      innodb => [
        ...
        @$optional_innodb_variables_105,
      ],
    }
  ],
  [ @$optional_redefines_105 ],
  [ @$optional_plugins_105 ],
  ...
  ##### Performance schema
  [ '', '', '',
    $perfschema_options_105 . ' --redefine=conf/runtime/performance_schema.yy',
  ],
  ##### Startup variables (general)
  [ @$optional_server_variables_105 ],
  [ @$optional_charsets_105 ],
];
