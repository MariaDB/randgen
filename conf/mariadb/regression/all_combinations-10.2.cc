...
our ($non_innodb_encryption_options, $innodb_encryption_options, $common_options, $ps_protocol_options, $perfschema_options_102);
our ($grammars_any_gendata, $grammars_specific_gendata, $gendata_files, $auto_gendata_combinations, $optional_redefines_102);
our ($views_combinations, $vcols_combinations, $threads_low_combinations, $binlog_combinations);
our ($optional_variators_102, $basic_engine_combinations_102);
our ($non_crash_scenario_combinations_102, $scenario_combinations_102);
our ($optional_innodb_variables_102, $optional_plugins_102, $optional_server_variables_102, $optional_charsets_102);
...
$combinations = [
  ...
  [ {
      transform => [
        [ '--validators=TransformerNoComparator' ], @$optional_variators_102,
      ],
      notransform => [ '' ]
    }
  ],
  ...
  ##### Performance schema
  [ '', '', '',
    $perfschema_options_102 . ' --redefine=conf/runtime/performance_schema.yy',
  ],
