...
select_is:
  PREPARE stmt FROM "SELECT CONCAT('SELECT * FROM INFORMATION_SCHEMA.',table_name,' ORDER BY RAND(_int_unsigned) LIMIT 10') FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='INFORMATION_SCHEMA' ORDER BY RAND(_int_unsigned) LIMIT 1"; EXECUTE stmt; DEALLOCATE PREPARE stmt
;
