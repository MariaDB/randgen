...
query:
    desc_indexes_add
  | ==FACTOR:2== ALTER __online(10) TABLE _basetable DROP KEY IF EXISTS { 'ord_index_'.$prng->uint16(1,$ind).'_'.abs($$) } desc_indexes_algorithm_optional
  ...
  | ==FACTOR:0.05== ALTER __online(10) TABLE _basetable FORCE desc_indexes_algorithm_optional
