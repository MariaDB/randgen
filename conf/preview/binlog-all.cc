...
#  $options{optional_ps_protocol},
  ...
  [
    '--scenario=Replication --reporter=ReplicationStartUntil',
    '--scenario=Replication --reporter=ReplicationStartUntil',
    '--scenario=Replication --reporter=ReplicationStartUntil',
    '--scenario=Replication --reporter=ReplicationStartUntil',
    '--scenario=Replication --reporter=ReplicationStartUntil',
    ...
    '--scenario=Replication',
    '--scenario=Replication',
    '--scenario=Standard --reporter=BinlogDump',
    '--scenario=Restart --reporter=BinlogDump',
    '--scenario=CrashRecovery --reporter=BinlogDump',
    '--scenario=CrashRecovery --reporter=BinlogDump',
#    '--scenario=AtomicDDL --reporter=BinlogDump',
    '--scenario=MariaBackupFull --reporter=BinlogDump',
    '--scenario=MariaBackupIncremental --reporter=BinlogDump',
    '--scenario=NormalUpgrades --reporter=BinlogDump',
  ],
