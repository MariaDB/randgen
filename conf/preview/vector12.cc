  ...
  [
    {
      ...
      custom_rpl => [
        ...
        [ '--grammar=conf/yy/dml.yy', @{$options{dml_grammars}}, @{$options{ddl_grammars}} ],
      ],
      galera => [
        [ '--scenario=Galera' ],
      ...
      index => [
        ...
        [ @{$options{optional_charsets_safe}} ],
        [ @{$options{optional_encryption}} ],
        [ '--grammar=conf/yy/many_indexes.yy', @{$options{dml_grammars}}, @{$options{ddl_grammars}}, @{$options{variables_grammars}}, @{$options{debug_grammars}} ],
        [ @{$options{optional_variators}} ],
        [ @{$options{optional_aria_variables}} ],
        [ @{$options{optional_binlog_safe_variables}} ],
        [ @{$options{optional_innodb_compression}} ],
      ...
      recovery => [
        ...
        [ @{$options{optional_charsets_safe}} ],
        [ @{$options{optional_encryption}} ],
        [ '--grammar=conf/yy/dml.yy', @{$options{dml_grammars}}, @{$options{ddl_grammars}}, @{$options{debug_grammars}} ],
        [ @{$options{optional_variators}} ],
        [ @{$options{optional_aria_variables}} ],
        [ @{$options{optional_binlog_safe_variables}} ],
        [ @{$options{optional_innodb_compression}} ],
      ...
      replication => [
        ...
        [ '--grammar=conf/yy/replication.yy', @{$options{dml_grammars}}, @{$options{ddl_grammars}} ],
        [ @{$options{optional_variators}} ],
        [ @{$options{optional_aria_variables}} ],
        [ @{$options{optional_binlog_safe_variables}} ],
        [ @{$options{optional_innodb_compression}} ],
      ...
      replication_mbr => [
        [ @{$options{scenario_replication_combinations}} ],
        [ '--mysqld=--log-bin --mysqld=--binlog-format=mixed --filter=conf/ff/replication.ff' ],
        [ @{$options{engine_basic_combinations}} ],
        [ @{$options{optional_charsets_safe}} ],
        [ @{$options{optional_replication_safe_variables}} ],
        [ '--grammar=conf/yy/replication.yy', @{$options{dml_grammars}}, @{$options{ddl_grammars}} ],
      ...
      replication_rbr => [
        [ @{$options{scenario_replication_combinations}} ],
        [ '--mysqld=--log-bin --mysqld=--binlog-format=row --filter=conf/ff/replication.ff' ],
        [ @{$options{engine_basic_combinations}} ],
        [ @{$options{optional_charsets_safe}} ],
        [ @{$options{optional_replication_safe_variables}} ],
        [ '--grammar=conf/yy/replication.yy', @{$options{dml_grammars}}, @{$options{ddl_grammars}} ],
      ...
      views => [
        [ '--scenario=Standard' ],
        [ @{$options{engine_basic_combinations}} ],
        [ '--gendata=advanced', '--gendata=simple --gendata=data/sql/updateable_views.sql' ],
        [ '--views', '--views=MERGE', '--views=TEMPTABLE' ],
        [ @{$options{optional_charsets_safe}} ],
        [ '--grammar=conf/yy/updateable_views.yy', @{$options{read_only_grammars}}, @{$options{dml_grammars}}, @{$options{ddl_grammars}} ],
      ...
      virtual_columns => [
        ...
        [ @{$options{engine_basic_combinations}} ],
        [ @{$options{optional_charsets_safe}} ],
        [ '--grammar=conf/yy/virtual_columns.yy', @{$options{read_only_grammars}}, @{$options{dml_grammars}}, @{$options{ddl_grammars}}, @{$options{variables_grammars}} ],
        [ @{$options{optional_variators}} ],
        [ @{$options{optional_aria_variables}} ],
        [ @{$options{optional_binlog_safe_variables}} ],
        [ @{$options{optional_innodb_compression}} ],
