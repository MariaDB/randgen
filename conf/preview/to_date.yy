...
func_date_func:
   ...
   ==FACTOR:500== TO_DATE( to_date_args ) |
   TO_DAYS( func_arg ) |
   TO_SECONDS( func_arg ) |
...
day_name:
  'Monday' | 'Tuesday' | 'Wednesday' | 'Thursday' | 'Friday' | 'Saturday' | 'Sunday' | 'UnknownDay' ;

# TODO: Extend with other languages
day_name_abbr:
  'Mon' | 'Tue' | 'Wed' | 'Thu' | 'Fri' | 'Sat' | 'Sun' | 'Udy' ;

# TODO: Extend with other languages
month_name:
  'January' | 'February' | 'March' | 'April' | 'May' | 'June' | 'July' | 'August' | 'September' | 'October' | 'November' | 'December' | 'UnknownMonth' ;

# TODO: Extend with other languages
month_name_abbr:
  'Jan' | 'Feb' | 'Mar' | 'Apr' | 'May' | 'Jun' | 'Jul' | 'Aug' | 'Sep' | 'Oct' | 'Nov' | 'Dec' | 'Umo' ;
...
# TODO: Extend with other languagues
nls_format_element:
