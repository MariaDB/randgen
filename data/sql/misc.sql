# Various structures taken from different sources, not belonging
# to a specific dataset or a clear category

DROP DATABASE IF EXISTS misc_db;
CREATE DATABASE misc_db;
USE misc_db;

############################
# From main/select.test
############################
