...
@EXPORT = qw(
  ...
  REPORTER_TYPE_END
  REPORTER_TYPE_SUCCESS_POST_SHUTDOWN
  REPORTER_TYPE_FAILURE_POST_SHUTDOWN
...
use constant REPORTER_TYPE_ALWAYS       => 32;
use constant REPORTER_TYPE_END          => 64;
use constant REPORTER_TYPE_SUCCESS_POST_SHUTDOWN => 128;
use constant REPORTER_TYPE_FAILURE_POST_SHUTDOWN => 256;
