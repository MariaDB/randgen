...
# use constant  ER_UNUSED_13                                      => 1561; # You should never see it
...
# ...
# use constant  ER_UNUSED_16                                      => 1721; # You should never see it
# ...
...
my %err2type = (
    ...
    ER_BINLOG_UNSAFE_ROUTINE()                          => STATUS_CONFIGURATION_ERROR,
    ER_BINLOG_UNSAFE_SKIP_LOCKED()                      => STATUS_RUNTIME_ERROR,
    ER_BINLOG_UNSAFE_SYSTEM_TABLE()                     => STATUS_RUNTIME_ERROR,
    ...
    ER_MALFORMED_DEFINER()                              => STATUS_SYNTAX_ERROR,
    ...
    ER_ROW_DOES_NOT_MATCH_GIVEN_PARTITION_SET()         => STATUS_DATABASE_CORRUPTION,
