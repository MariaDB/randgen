...
my %err2type = (
    ...
    ER_AUTOINC_READ_FAILED()                            => STATUS_ALARM,
    ...
    ER_BINLOG_ROW_LOGGING_FAILED()                      => STATUS_REPLICATION_FAILURE,
    ...
    ER_FAILED_READ_FROM_PAR_FILE()                      => STATUS_ENVIRONMENT_FAILURE,
    ...
    ER_SP_NO_AGGREGATE()                                => STATUS_NOT_SUPPORTED,
