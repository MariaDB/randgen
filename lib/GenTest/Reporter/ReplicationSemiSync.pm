...
sub isSlaveBehind {
	...
	my $slave_status = $slave_dbh->selectrow_hashref("SHOW SLAVE STATUS /* ReplicationSemiSync::isSlaveBehind */");
	my ($master_log_file, $read_master_log_pos) = ($$slave_status{'Master_Log_File'}, $$slave_status{'Read_Master_Log_Pos'});
